<template>
  <div
    ...
    tabindex="-1"
    aria-hidden="true"
    class="fixed top-0 left-0 right-0 z-50 bg-gray-900 bg-opacity-50 dark:bg-opacity-80 inset-0 hidden w-screen p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full"
  >
