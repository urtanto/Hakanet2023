  ...
  <hack-modal idModal="registerModal" nameModal="Регистрация">
    <form @submit="register" action="#" class="flex flex-col gap-8">
      ...
      <hack-input idInput="password" typeInput="password" nameInput="password" :visible="formData.visiblePass.value"
        ...
        <div class="flex items-center">
          <svg fill="currentColor" viewBox="0 0 20 20" class="w-5 h-5 text-gray-500 dark:text-gray-400"
            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path clip-rule="evenodd" fill-rule="evenodd"
      ...
      <div class="flex items-center">
        <input checked id="checkbox-1" type="checkbox" value="accepted"
